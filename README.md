Create account on behalf of James

-> Country
-> Name

Create a plan on behalf of James (Within James' account)

->Amount
->Frequency

Create a customer on behalf of James (Within James' account)

->Name
->Bank Account

Subscribe Rory to James' plan, commissioning the platform
